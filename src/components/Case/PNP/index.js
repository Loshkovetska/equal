import preview from '../../../images/cases/pnp/pnpimage.png'

import pnp1 from '../../../images/cases/pnp/image1.png'
import pnp2 from '../../../images/cases/pnp/image2.png'
import pnp3 from '../../../images/cases/pnp/image3.png'
import pnp4 from '../../../images/cases/pnp/image4.png'
import pnp5 from '../../../images/cases/pnp/image5.png'
...
export const pnp =
{
    ...
    title: 'PNP',
    link: '/PNP',
    types: ['WEB APP','MOBILE APP','WEBSITEs'],
    src: preview,
    info: `<ul>
      <li class="slide-wrap">
       <div class="slide-up">
 ...
 PNP</p>
      ...
      <div class="slide-up">  <h3>ROLE</h3>
        <p>
Strategy / UX & UI / Graphic desgin</p> </div>
      </li>
      <li  class="slide-wrap">
      ...
      <div class="slide-up">  <h3>CLIENT SAYS</h3>
        <p>«They’ve managed everything professionally.»</p>
         <p class="grey">Richard Bell, Jeremy Light, Co-Founders PNP</p>
          </div>
